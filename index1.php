...
<body>
    <header>
      ...
      <script>
        var i = 0;
        var images = ['image.jpg', 'image5.jpg', 'image3.jpg', 'image2.jpg'];
        var time = 4000;
...
<br>
 ...
 <div class="section-container">
         <div class="columns image" style="background-image:url('./image.jpg')">
             &nbsp;
         </div>
 ...
 <div class="section">
  ...
  <div class="services">
      ...
      <div class="card">
          ...
          <p>We Provide. A menu specially designed for your event; A friendly and dynamic team for service during the event.</p>
      </div>
      <div class="card">
          <div class="icon">
      ...
      <div class="card">
          ...
          <h2>Bar & Drink</h2>
          <p>Enjoy your favorite wine at our bar with a selection of spirits, whisky, brandy, liqueurs, soft drinks, beer, and light bites.</p>
      </div>
      <br>
      <div class="card">
          <div class="icon">
